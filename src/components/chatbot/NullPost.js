...
class NullPost extends Component {


    constructor(props) {
        super(props);
        const { steps } = this.props;
        const { giveContactDetails, getContactDetails  } = steps;

        this.state = { giveContactDetails, getContactDetails  };
    }
    ...
    componentDidMount() {
        const userObject = {
            ...
            get_contact: this.state.getContactDetails.value,
